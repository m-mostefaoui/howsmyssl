...
CMD ["/bin/bash", "-c", "howsmyssl \
    ...
    -cert=/go/src/github.com/m-mostefaoui/howsmyssl/certs/myssl.parcelvision.info_20180809-135141.crt \
    -key=/go/src/github.com/m-mostefaoui/howsmyssl/certs/key.pem"]
